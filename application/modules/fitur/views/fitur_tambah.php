                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <input required type="text" class="form-control" id="NAMA_FITUR" name="NAMA_FITUR">
                                            ...
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <textarea required name="KETERANGAN" placeholder="Masukkan keterangan fitur" class="form-control" id="KETERANGAN"></textarea>
                                                <div class="invalid-feedback">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('#FORM_FITUR_TAMBAH').on('submit', function(e) {
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>" + "fitur/insert_fitur", // Endpoint untuk proses input
                            type: 'POST',
                            data: formData,
