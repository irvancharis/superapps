                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <input readonly required type="text" value="<?= $get_single->NAMA_KARYAWAN; ?>" class="form-control" id="NAMA_KARYAWAN" name="NAMA_KARYAWAN">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <select readonly required name="STATUS_KARYAWAN" id="STATUS_KARYAWAN" class="form-control">
