                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-header-action">
                                        <a href="<?php echo base_url('maping_ruangan/tambah') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a href="<?=site_url('maping_ruangan/detail/'.$d->KODE_RUANGAN);?>" class="dropdown-kategori has-icon view-btn" ><i class="fas fa-eye"></i> View</a>
                                                                    <a href="<?=site_url('maping_ruangan/edit/'.$d->KODE_RUANGAN);?>" class="dropdown-kategori has-icon edit-btn" ><i class="far fa-edit"></i> Edit</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a href="<?=site_url('maping_ruangan/hapus/'.$d->KODE_RUANGAN);?>" class="dropdown-kategori has-icon text-danger hapus-btn"  onclick="return confirm('Yakin akan menghapus data?')"><i class="far fa-trash-alt"></i>
                                                                        Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form id="formHapusproduk">
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="hidden" id="id_technician_hapus" class="form-control" placeholder="ID" name="KODE_RUANGAN">
            ...
            <script>
                $(document).ready(function() {                   
                    ...
                    $('#formHapusproduk').on('submit', function(e) {
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>" + "maping_ruangan/hapus", // Endpoint untuk proses input
                            type: 'POST',
                            data: formData,
