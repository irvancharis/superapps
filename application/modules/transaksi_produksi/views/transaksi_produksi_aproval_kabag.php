                ...
                <div class="card">
                    <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PRODUKSI">
                        <div class="card-header">
                            <h4>APROVAL KABAG TRANSAKSI PRODUKSI</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-12 col-md-12 col-lg-12">
                                ...
                                <textarea name="KETERANGAN_PRODUKSI" placeholder="Masukkan keterangan produksi"
                                    class="form-control"
                                    id="KETERANGAN_PRODUKSI"><?= $get_single->KETERANGAN_PRODUKSI; ?></textarea>
        ...
        $('#FORM_TRANSAKSI_PRODUKSI').on('submit', function(e) {
            ...
            swal({
                ...
                if (confirm) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>" + "transaksi_produksi/update_approval_kabag",
                        type: "POST",
                        data: {
            ...
            swal({
                ...
                if (confirm) {
                    swal({
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>transaksi_produksi/disapprove_kabag/",
                            type: "POST",
                            data: {
                                UUID_TRANSAKSI_PRODUKSI: '<?= $get_single->UUID_TRANSAKSI_PRODUKSI ?>',
