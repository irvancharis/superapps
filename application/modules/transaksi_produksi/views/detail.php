                ...
                <div class="card">
                    <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PRODUKSI">
                        <div class="card-header">
                            <h4>DETAIL TRANSAKSI PRODUKSI</h4>
                                ...
                                <table class="table table-striped table-sm table-bordered" id="dataprodukitem">
                                    ...
                                    <tbody id="selected-items-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $row->JUMLAH_PRODUKSI; ?></td>
                                            <td><?= $row->KEPERLUAN; ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="text-left col-3">KETERANGAN :
                                                <?= $transaksi->KETERANGAN_PRODUKSI; ?></th>
                                        </tr>
                                        <tr>
                                            <th class="text-left col-3">STATUS PRODUKSI :
                                                <?php if($transaksi->STATUS_PRODUKSI == 'MENUNGGU APROVAL KABAG')
                                                            {
                                                        ?>
                                                <span class="badge badge-primary">MENUNGGU APROVAL KABAG</span>
                                                <?php
                                                            }
                                                            elseif($transaksi->STATUS_PRODUKSI == 'MENUNGGU PENYERAHAN')
                                                            {
                                                        ?>
                                                <span class="badge badge-warning">MENUNGGU PENYERAHAN</span>
                                                <?php
                                                        }
                                                            elseif($transaksi->STATUS_PRODUKSI == 'SELESAI')
                                                            {
                                                        ?>
                                                <span class="badge badge-success">SELESAI</span>
                                                <?php
                                                        }
                                                            elseif($transaksi->STATUS_PRODUKSI == 'DITOLAK KABAG')
                                                            {
                                                        ?>
