                ...
                <div class="card">
                    <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PRODUKSI">
                        <div class="card-header">
                            <h4>APROVAL HEAD TRANSAKSI PRODUKSI</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-12 col-lg-12">
                                    <table class="table table-striped table-sm ">
                                        <tbody>
                                            <tr>
                                                <th class="text-left col-3">KETERANGAN : <?= $get_single->KETERANGAN_PRODUKSI; ?></th>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
            ...
            selectedItems.forEach(function(item, index) {
                tbody.append(`
                                <tr data-index="${index}">
                                    ...
                                    <td class="text-center col-2"><center><img width="100px" src="<?php echo base_url('assets/uploads/transaksi_produksi/') ?>${item.FOTO_AWAL}" alt=""></center></td>
                                    <td>${item.NAMA_PRODUK}</td>
                                    <td class="text-center col-1">${item.JUMLAH_PRODUKSI}</td>
        ...
        $('#FORM_TRANSAKSI_PRODUKSI').on('submit', function(e) {
            ...
            swal({
                ...
                if (confirm) {
                    ...
                    formData['KETERANGAN_PRODUKSI'] = $('#KETERANGAN_PRODUKSI').val();
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>" + "transaksi_produksi/update_approval_head",
                        type: "POST",
                        data: {
            ...
            swal({
                ...
                if (confirm) {
                    swal({
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>transaksi_produksi/disapprove_head/",
                            type: "POST",
                            data: {
                                UUID_TRANSAKSI_PRODUKSI: '<?= $get_single->UUID_TRANSAKSI_PRODUKSI ?>',
                            ...
                            success: function(response) {
                                let res = JSON.parse(response);
                                if (res.success) {
                                    swal('Sukses', 'Transaksi Produksi Berhasil Ditolak!',
