                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12 col-md-12 col-lg-12">
                                                ...
                                                <input required type="text" class="form-control" id="NAMA_LOKASI" value="<?= $get_maping_lokasi->NAMA_LOKASI; ?>" name="NAMA_LOKASI">
                                            </div>                                            
                                            
                                            <div class="form-group col-12 col-md-12 col-lg-12">
                                                <label>KETERANGAN LOKASI</label>
                                                <textarea required name="KETERANGAN_LOKASI" placeholder="Masukkan keterangan lokasi" class="form-control" id="description_ticket"><?= $get_maping_lokasi->KETERANGAN_RUANGAN; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
