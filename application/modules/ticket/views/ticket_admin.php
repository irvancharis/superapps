                    ...
                    <div class="section-body">
                        <div class="invoice">
                            ...
                            <div class="text-md-right">
                                ...
                                <a href="<?php echo base_url('ticket/cetak_progress_ticket/' . $ticket->IDTICKET); ?>" class="btn btn-warning btn-icon icon-left" target="_blank"><i class="fas fa-print"></i> Print</a>
                            </div>
                        </div>
                    </div>
                </section>
