                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <div class="selectgroup selectgroup-pills">
                                                    ...
                                                    <label class="selectgroup-item">
                                                        <input type="radio" name="status_ticket" value="25" class="selectgroup-input-radio" id="status1" <?= ($status_ticket == 25) ? 'checked' : ''; ?> disabled>
                                                        <span class="selectgroup-button status <?= $status_ticket == 25 ? 'bg-primary text-white' : ''; ?>" id="label-status1">SEDANG DIKERJAKAN</span>
                                                    </label>
                                                    <label class="selectgroup-item">
                                                        <input type="radio" name="status_ticket" value="50" class="selectgroup-input-radio" id="status2" <?= ($status_ticket == 50) ? 'checked' : ''; ?> disabled>
                                                        <span class="selectgroup-button status <?= $status_ticket == 50 ? 'bg-danger text-white' : ''; ?>" id="label-status2">MENUNGGU VALIDASI</span>
                                                    </label>
                                                    <label class="selectgroup-item">
                                                        <input type="radio" name="status_ticket" value="100" class="selectgroup-input-radio" id="status3" <?= ($status_ticket == 100) ? 'checked' : ''; ?> disabled>
                                                        <span class="selectgroup-button status <?= $status_ticket == 100 ? 'bg-success text-white' : ''; ?>" id="label-status3">SELESAI</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group col-12 col-md-6 col-lg-6">
