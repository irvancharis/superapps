...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/'); ?>css/adminx.css" media="screen" />
    ...
    <div class="adminx-container">
      ...
      <nav class="navbar navbar-expand justify-content-between fixed-top">
        <a class="navbar-brand mb-0 h1 d-none d-md-block" href="index.html">
          <img src="<?= base_url('assets/'); ?>img/logo.png" class="navbar-brand-image d-inline-block align-top mr-2" alt="">
          INVENTORI
        </a>
