                ...
                <div class="card">
                    <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PEMINDAHAN">
                        <div class="card-header">
                            <h4>APROVAL KABAG TRANSAKSI PEMINDAHAN</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-12 col-md-12 col-lg-12">
                                ...
                                <textarea name="KETERANGAN_PEMINDAHAN" placeholder="Masukkan keterangan pemindahan"
                                    class="form-control"
                                    id="KETERANGAN_PEMINDAHAN"><?= $get_single->KETERANGAN_PEMINDAHAN; ?></textarea>
        ...
        $('#FORM_TRANSAKSI_PEMINDAHAN').on('submit', function(e) {
            ...
            swal({
                ...
                if (confirm) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>" + "transaksi_pemindahan/update_approval_kabag",
                        type: "POST",
                        data: {
            ...
            swal({
                ...
                if (confirm) {
                    swal({
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>transaksi_pemindahan/disapprove_kabag/",
                            type: "POST",
                            data: {
                                UUID_TRANSAKSI_PEMINDAHAN: '<?= $get_single->UUID_TRANSAKSI_PEMINDAHAN ?>',
