                ...
                <section class="section">
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PENGHAPUSAN_EDIT">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <input required type="text" value="<?= $get_single->NAMA_TRANSAKSI_PENGADAAN; ?>" class="form-control" id="NAMA_TRANSAKSI_PENGADAAN" name="NAMA_TRANSAKSI_PENGADAAN">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <select required name="STATUS_TRANSAKSI_PENGADAAN" id="STATUS_TRANSAKSI_PENGADAAN" class="form-control">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    // Input Area
                    $('#FORM_TRANSAKSI_PENGHAPUSAN_EDIT').on('submit', function(e) {
                        e.preventDefault();
