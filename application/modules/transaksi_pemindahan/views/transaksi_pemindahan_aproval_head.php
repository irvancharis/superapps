                ...
                <div class="card">
                    <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PEMINDAHAN">
                        <div class="card-header">
                            <h4>APROVAL HEAD TRANSAKSI PEMINDAHAN</h4>
        ...
        $('#FORM_TRANSAKSI_PEMINDAHAN').on('submit', function(e) {
            ...
            swal({
                ...
                if (confirm) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>" + "transaksi_pemindahan/update_approval_head",
                        type: "POST",
                        data: {
            ...
            swal({
                ...
                if (confirm) {
                    swal({
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>transaksi_pemindahan/disapprove_head/",
                            type: "POST",
                            data: {
                                UUID_TRANSAKSI_PEMINDAHAN: '<?= $get_single->UUID_TRANSAKSI_PEMINDAHAN ?>',
