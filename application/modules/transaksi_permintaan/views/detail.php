                ...
                <div class="card">
                    <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PERMINTAAN">
                        <div class="card-header">
                            <h4>DETAIL TRANSAKSI PERMINTAAN</h4>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="text-left col-3">KETERANGAN :
                                                <?= $transaksi->KETERANGAN_PERMINTAAN; ?></th>
                                        </tr>
                                        <tr>
                                            <th class="text-left col-3">STATUS PERMINTAAN :
                                                <?php if($transaksi->STATUS_PERMINTAAN == 'MENUNGGU APROVAL KABAG')
                                                            {
                                                        ?>
                                                <span class="badge badge-primary">MENUNGGU APROVAL KABAG</span>
                                                <?php
                                                            }
                                                            elseif($transaksi->STATUS_PERMINTAAN == 'MENUNGGU PENYERAHAN')
                                                            {
                                                        ?>
                                                <span class="badge badge-warning">MENUNGGU PENYERAHAN</span>
                                                <?php
                                                        }
                                                            elseif($transaksi->STATUS_PERMINTAAN == 'SELESAI')
                                                            {
                                                        ?>
                                                <span class="badge badge-success">SELESAI</span>
                                                <?php
                                                        }
                                                            elseif($transaksi->STATUS_PERMINTAAN == 'DITOLAK KABAG')
                                                            {
                                                        ?>
