                ...
                <div class="card">
                    <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PERMINTAAN">
                        <div class="card-header">
                            <h4>APROVAL KABAG TRANSAKSI PERMINTAAN</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-12 col-md-12 col-lg-12">
                                ...
                                <textarea name="KETERANGAN_PERMINTAAN" placeholder="Masukkan keterangan permintaan"
                                    class="form-control"
                                    id="KETERANGAN_PERMINTAAN"><?= $get_single->KETERANGAN_PERMINTAAN; ?></textarea>
        ...
        $('#FORM_TRANSAKSI_PERMINTAAN').on('submit', function(e) {
            ...
            swal({
                ...
                if (confirm) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>" + "transaksi_permintaan/update_approval_kabag",
                        type: "POST",
                        data: {
            ...
            swal({
                ...
                if (confirm) {
                    swal({
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>transaksi_permintaan/disapprove_kabag/",
                            type: "POST",
                            data: {
                                UUID_TRANSAKSI_PERMINTAAN: '<?= $get_single->UUID_TRANSAKSI_PERMINTAAN ?>',
