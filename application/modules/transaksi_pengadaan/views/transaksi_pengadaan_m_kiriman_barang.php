                                ...
                                <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PENGADAAN_PROSES_PENGADAAN">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12 col-md-6 col-lg-6 about accelerator">
                                                <label>NO.RESI</label><span class="text-danger float-right font-italic font-weight-600">*). Wajib Di Isi</span>
                                                <input required type="text" class="form-control" id="NO_RESI" name="NO_RESI" value="<?= $m_kiriman_barang->NO_RESI; ?>">
                                                <div class="invalid-feedback">
                                                    Masukkan NO. RESI !
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer text-center row">
                                        ...
                                        <div class="col-12 col-md-8 col-lg-7 col-xl-7 mb-2 mb-md-0 text-md-right">
                                            <button type="submit" class="btn btn-success" id="btn-approve"><i class="fa fa-check"></i> TERIMA KIRIMAN BARANG</button>
                                        </div>
                    ...
                    $('#FORM_TRANSAKSI_PENGADAAN_PROSES_PENGADAAN').on('submit', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                let res = JSON.parse(response);
                                if (res.success) {
                                    swal('Sukses', 'Pengadaan Berhasil Di Proses!', 'success').then(function() {
