                            ...
                            <div class="card">
                                <form class="needs-validation" novalidate="" id="FORM_TRANSAKSI_PENGADAAN_TAMBAH">
                                    ...
                                    <div class="card-body">
                                        <div class="row mt-2">
                                            ...
                                            <div class="form-group col-12 col-md-6 col-lg-6">
                                                ...
                                                <select disabled name="DEPARTEMEN_PENGAJUAN" id="DEPARTEMEN_PENGAJUAN"
                                                    class="form-control">
                                    ...
                                    <div class="card-footer text-center">
                                        <button type="submit" class="btn btn-primary mx-2" id="btn-simpan"><i
                                                class="fa fa-save"></i> SIMPAN</button>
                                        <a href="<?php echo base_url(); ?>transaksi_pengadaan"
                                            class="btn btn-secondary"><i class="fa fa-times"></i> BATAL</a>
                                    </div>
                                </form>
                            </div>
                        </div>
